...
int main() {
    ...
    fromString<int>("-00002147483648");
    fromString<int>("00002147483647");

	try {
        fromString<int>("-2147483649");
	}
	...
	fromString<float>("12345.6789");

	try {
        fromString<float>("12345.678w9");
	}
	catch (UnknownChar & e) {
		std::cout << "UnknownChar!" << std::endl;
	}
